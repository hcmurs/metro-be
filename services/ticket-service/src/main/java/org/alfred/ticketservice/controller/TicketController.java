...
public class TicketController {
  ...
  @PreAuthorize("hasAuthority('ROLE_CUSTOMER')")
  public ResponseEntity<ApiResponse<TicketResponse>> createTicketType(
      @Valid @RequestBody TicketRequest.TicketType request) {
    log.info("Request to create ticket for type ID: {}", request.id());
    TicketResponse createdTicket = ticketService.createTicketType(request);
    return new ResponseEntity<>(
        ApiResponse.success(createdTicket, "Ticket created successfully"), HttpStatus.CREATED);
  }

  @PostMapping("/fare-matrix")
  @PreAuthorize("hasAuthority('ROLE_CUSTOMER')")
  public ResponseEntity<ApiResponse<TicketResponse>> createTicketFare(
      @Valid @RequestBody TicketRequest.FareMatrix request) {
    log.info("Request to create ticket for type ID: {}", request.id());
  ...
  public ResponseEntity<ApiResponse<TicketResponse>> scanEntryTicket(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(scannedTicket, "Ticket entry processed successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<TicketResponse>> scanExitTicket(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(scannedTicket, "Ticket exit processed successfully"));
  }
  ...
  @PreAuthorize("hasAuthority('ROLE_CUSTOMER')")
  public ResponseEntity<ApiResponse<byte[]>> generateQrCodeData(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(qrCodeData, "QR code data generated successfully"));
  }
