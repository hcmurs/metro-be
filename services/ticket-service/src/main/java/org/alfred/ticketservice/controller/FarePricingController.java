...
public class FarePricingController {
  ...
  @GetMapping("/{id}")
  @Operation(
      summary = "Get fare pricing by ID",
      description = "Retrieves fare pricing details by ID")
  ...
  public ApiResponse<FarePricingResponse> createFarePricing(
  ...
  @PutMapping("/{id}")
  @Operation(
      summary = "Update fare pricing",
      description = "Updates an existing fare pricing entry")
  public ApiResponse<FarePricingResponse> updateFarePricing(
      @PathVariable Long id, @Valid @RequestBody FarePricingRequest farePricing) {
  ...
  @DeleteMapping("/{id}")
  @Operation(
      summary = "Disable fare pricing",
      description = "Disables an existing fare pricing entry")
