...
public class TicketTypeController {
  ...
  public ResponseEntity<ApiResponse<?>> getAllTicketTypes(
    ...
    if (ticketCode != null && !ticketCode.isEmpty()) {
      ...
      return ResponseEntity.ok(
          ApiResponse.success(ticketType, "Ticket types retrieved successfully"));
    }
    List<TicketTypeResponse> ticketTypes = ticketTypeService.getAll();
    return ResponseEntity.ok(
        ApiResponse.success(ticketTypes, "Ticket types retrieved successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<TicketTypeResponse>> updateTicketType(
      @Valid @RequestBody TicketTypeRequest request, @PathVariable Long id) {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(updatedTicketType, "Ticket type updated successfully"));
  }
