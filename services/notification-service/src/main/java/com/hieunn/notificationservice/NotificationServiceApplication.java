...
import com.hieunn.notificationservice.configs.CRLFLogConverter;
...
public class NotificationServiceApplication {
  ...
  public NotificationServiceApplication(Environment env) {
    this.env = env;
  }

  public static void main(String[] args) {
    var env = SpringApplication.run(NotificationServiceApplication.class, args);
