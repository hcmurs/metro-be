...
public class OrderController {
    ...
    @PostMapping("/create")
    @Operation(summary = "Create a new order", description = "Creates a new order for a user based on the provided order request.")
    public ApiResponse<OrderResponse> createOrder(@RequestBody OrderRequest orderRequest) {
        // Logic to create an order
        return ordersService.generateOrders(orderRequest);
    }
