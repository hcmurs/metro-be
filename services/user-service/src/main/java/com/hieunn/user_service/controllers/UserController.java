...
public class UserController {
  ...
  public ResponseEntity<ApiResponse<?>> isUsernameExist(@RequestParam String username) {
  ...
  public ResponseEntity<ApiResponse<?>> isEmailExist(@RequestParam String email) {
  ...
  public ResponseEntity<ApiResponse<Void>> resetPassword(
    ...
    userService.resetPassword(
        resetPasswordRequest.getEmail(), resetPasswordRequest.getNewPassword());
