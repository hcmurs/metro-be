...
public class BlogController {
  ...
  public ResponseEntity<ApiResponse<BlogDTO.BlogPageResPB>> listBlogs(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            pocketBaseService.getBlogs(page, perPage), "Blogs retrieved successfully"));
  }

  @GetMapping("/pocketbase/{id}")
  @PreAuthorize("permitAll()")
  @Operation(summary = "Get blog by ID", description = "Retrieve a blog by its unique identifier")
  @Deprecated
  ...
  @Operation(summary = "Create a new blog", description = "Create a new blog entry")
  public ResponseEntity<ApiResponse<Blog>> createBlog(@Valid @RequestBody BlogDTO.BlogReq request) {
  ...
  @PutMapping("/{id}")
  //    @PreAuthorize("hasRole('ADMIN')")
  @Operation(summary = "Update a blog", description = "Update an existing blog by its ID")
  public ResponseEntity<ApiResponse<Blog>> updateBlog(
      @PathVariable Integer id, @Valid @RequestBody BlogDTO.BlogReq request) {
