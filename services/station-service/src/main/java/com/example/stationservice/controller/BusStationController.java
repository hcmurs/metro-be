...
public class BusStationController {
  ...
  @PutMapping("/{id}")
  public ApiResponse<BusStations> updateBusStation(
      @PathVariable String id, @RequestBody BusStations busStation) {
  ...
  public ApiResponse<Response.BusStationResponse> getBusRoutes(@PathVariable String stationId) {
    Response.BusStationResponse busStationResponse =
        busStationService.getBusStationRoutesStationId(stationId);
