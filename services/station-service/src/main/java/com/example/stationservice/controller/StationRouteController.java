...
public class StationRouteController {
  ...
  @Operation(
      summary = "Get station routes by route ID",
      description = "Retrieves all station routes for a specific route")
  public ApiResponse<List<StationRouteResponse>> getStationRoutesByRouteId(
      @PathVariable Long routeId) {
    List<StationRouteResponse> stationRoutes =
        stationRouteService.getStationRoutesByRouteId(routeId);
    return ApiResponse.success(stationRoutes, "Station routes retrieved successfully");
  }

  @GetMapping("/{id}")
  @Operation(
      summary = "Get station route by ID",
      description = "Retrieves a specific station route by its ID")
  ...
  public ApiResponse<StationRouteResponse> saveStationRoute(
  ...
  public ApiResponse<StationRouteResponse> updateStationRoute(
      @PathVariable Long id, @Valid @RequestBody StationRouteRequest stationRoute) {
  ...
  @PreAuthorize("hasAuthority('ROLE_ADMIN')")
  @Operation(
      summary = "Delete station route",
      description = "Deletes a station route and reorders remaining routes")
  ...
  @PreAuthorize("hasAuthority('ROLE_ADMIN')")
  @Operation(
      summary = "Reorder station routes",
      description = "Reorders station routes after deletion")
  ...
  @PutMapping("/swap")
  @Operation(
      summary = "Swap station route order",
      description = "Swaps the order of two station routes")
  public ApiResponse<Void> swapStationRouteOrder(
      @RequestParam Long firstStationRouteId, @RequestParam Long secondStationRouteId) {
