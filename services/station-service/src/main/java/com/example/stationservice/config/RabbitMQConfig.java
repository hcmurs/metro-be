...
public class RabbitMQConfig {
  ...
  public Binding stationDeleteBinding() {
    return BindingBuilder.bind(stationDeleteQueue())
        .to(stationExchange())
  ...
  public Binding stationAddBinding() {
    return BindingBuilder.bind(stationAddQueue())
        .to(stationExchange())
  ...
  public Binding dlqDeleteBinding() {
    return BindingBuilder.bind(stationDeleteDLQ())
  ...
  public Binding dlqAddBinding() {
    return BindingBuilder.bind(stationAddDLQ()).to(deadLetterExchange()).with("station.add.dlq");
  }
}
