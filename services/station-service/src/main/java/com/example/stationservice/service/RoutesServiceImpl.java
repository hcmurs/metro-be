...
public class RoutesServiceImpl implements RoutesService {
  ...
  public List<RoutesResponse> getAllRoutes() {
    ...
    return list.stream().map(route -> modelMapper.map(route, RoutesResponse.class)).toList();
  }
  ...
  public void deleteRoute(Long id) {
    ...
    List<StationRoute> stationRoutes =
        stationRouteRepository.findByRoute_RouteIdAndIsDeletedOrderBySequenceOrder(id, false);
