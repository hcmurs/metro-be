...
public class SchedulesServiceImpl implements SchedulesService {
  ...
  public SchedulesResponse createSchedule(SchedulesRequest request) {
    ...
    if (request.getTimeArrival() != null
        && request.getTimeDeparture() != null
  ...
  public SchedulesResponse updateSchedule(Long id, SchedulesRequest scheduleUpdate) {
    ...
    if (existingSchedule.getTimeArrival() != null
        && existingSchedule.getTimeDeparture() != null
    ...
    if (scheduleUpdate.getStationId() != null
      ...
      StationRoute station =
          stationRouteRepository
              .findById(scheduleUpdate.getStationId())
              .orElseThrow(
                  () ->
                      new EntityNotFoundException(
                          "Station not found with id: " + scheduleUpdate.getStationId()));
