...
public class SchedulesController {
  ...
  public ApiResponse<List<SchedulesResponse>> getSchedulesByStationId(
  ...
  @PutMapping("/{id}")
  @PreAuthorize("hasAuthority('ROLE_ADMIN')")
  public ApiResponse<SchedulesResponse> updateSchedule(
      @PathVariable Long id, @RequestBody SchedulesRequest schedule) {
