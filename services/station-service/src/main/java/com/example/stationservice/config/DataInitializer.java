...
public class DataInitializer implements CommandLineRunner {
    ...
    List<Stations> stations =
        List.of(
            create(
                "BXMD",
                "Bến xe Miền Đông",
                "Bến xe Miền Đông mới (Suối Tiên)",
                10.879512241390108,
                106.81409560253722),
            create(
                "DHQG",
            ...
            create(
                "BTH", "Bình Thái", "Trường Thọ, Thủ Đức", 10.832601114841145, 106.76384478331777),
            create(
                "PL",
                "Phước Long",
                "Phước Long A, Thủ Đức",
                10.821356644499083,
                106.75813941185976),
            ...
            create(
                "CVVT",
                "Công viên Văn Thánh (Văn Thánh Park)",
                "Bình Thạnh",
                10.796069240758085,
                106.71553225518468),
  ...
  private void createSchedulesForDirection(
      List<StationRoute> stations,
      LocalTime startTime,
      LocalTime endTime,
      Schedules.Direction direction) {
    ...
    while (currentTime.isBefore(endTime) || currentTime.equals(endTime)) {
      ...
      for (int i = 0; i < stations.size(); i++) {
        ...
        scheduleRequest.setDescription(
            String.format(
                "Chuyến %s lúc %s - Trạm",
                direction == Schedules.Direction.forward ? "đi" : "về", tripStartTime.toString()));
