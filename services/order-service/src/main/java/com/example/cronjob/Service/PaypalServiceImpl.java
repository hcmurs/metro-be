...
public class PaypalServiceImpl {
  ...
  public String getAccessToken() {
    ...
    ResponseEntity<Map> response =
        restTemplate.exchange(paypalBaseUrl + "/v1/oauth2/token", HttpMethod.POST, body, Map.class);
  ...
  public String createOrder(Long orderId, String currency, String description) {
    ...
    Map<String, Object> orderPayload =
        Map.of(
            ...
            "purchase_units",
                List.of(
                    Map.of(
                        "amount", Map.of("currency_code", currency, "value", amount.toString()),
    ...
    ResponseEntity<Map> response =
        restTemplate.exchange(
            paypalBaseUrl + "/v2/checkout/orders", HttpMethod.POST, request, Map.class);
  ...
  public Long getCustomOrderIdFromPayPalOrderId(String paypalOrderId) {
    try {
      ...
      List<Map<String, Object>> purchaseUnits =
          (List<Map<String, Object>>) response.getBody().get("purchase_units");
