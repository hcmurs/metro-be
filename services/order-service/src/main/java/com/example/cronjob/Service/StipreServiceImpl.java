...
public class StipreServiceImpl implements StripeService {
  ...
  @Autowired TicketClient ticketClient;
  ...
  public StripeResponse.StripePaymentResponse checkoutOrder(StripeRequest.ProductRequest request) {
    ...
    SessionCreateParams.LineItem.PriceData.ProductData orderData =
    ...
    Long usdCents =
        usdAmount.multiply(BigDecimal.valueOf(100)).setScale(0, RoundingMode.HALF_UP).longValue();
    ...
    SessionCreateParams.LineItem lineItem =
        SessionCreateParams.LineItem.builder().setPriceData(priceData).setQuantity(1L).build();
  ...
  @Override
  public StripeResponse.StripePaymentMobileResponse checkoutOrderMobile(
