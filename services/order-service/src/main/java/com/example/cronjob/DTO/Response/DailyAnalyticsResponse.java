...
public class DailyAnalyticsResponse {
  ...
  public DailyAnalyticsResponse(
      ...
      Integer peakHourTickets,
      Integer offPeakTickets,
      Integer singleJourneyCount,
      Integer passTicketsCount,
      Integer oneDayTicketsCount,
      Integer threeDayTicketsCount,
      Integer weekTicketsCount,
      Integer monthTicketsCount,
      Integer studentTicketsCount,
      BigDecimal avgJourneyDistance,
